...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        // Next, move stuff
        if (movesPending) {
            final ArrayList<BaseItemAnimator.MoveInfo> moves = new ArrayList<BaseItemAnimator.MoveInfo>();
        ...
        if (changesPending) {
            final ArrayList<BaseItemAnimator.ChangeInfo> changes = new ArrayList<BaseItemAnimator.ChangeInfo>();
    ...
    private void doAnimateRemove(final ViewHolder holder) {
        if (holder instanceof AnimateViewHolder) {
            ((AnimateViewHolder) holder).animateRemoveImpl(new BaseItemAnimator.DefaultRemoveVpaListener(holder));
        } else {
    ...
    private void doAnimateAdd(final ViewHolder holder) {
        if (holder instanceof AnimateViewHolder) {
            ((AnimateViewHolder) holder).animateAddImpl(new BaseItemAnimator.DefaultAddVpaListener(holder));
        } else {
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new BaseItemAnimator.VpaListenerAdapter() {
            @Override
    ...
    private void animateChangeImpl(final BaseItemAnimator.ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(new BaseItemAnimator.VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).
                    alpha(1).setListener(new BaseItemAnimator.VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
