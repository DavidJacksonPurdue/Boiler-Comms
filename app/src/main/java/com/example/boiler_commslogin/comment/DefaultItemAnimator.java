...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(1).setListener(new DefaultItemAnimator.VpaListenerAdapter() {
            @Override
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(1).setDuration(getAddDuration()).
                setListener(new DefaultItemAnimator.VpaListenerAdapter() {
                    @Override
                    public void onAnimationStart(View view) {
    ...
    private void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new DefaultItemAnimator.VpaListenerAdapter() {
            @Override
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final DefaultItemAnimator.ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(new DefaultItemAnimator.VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).
                    alpha(1).setListener(new DefaultItemAnimator.VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
