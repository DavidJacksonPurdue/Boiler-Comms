...
public class checkIfFollowCase extends AsyncTask {
    ...
    public checkIfFollowCase(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try {
            url = new URL(Constants.checkIfCanDMFromFollow + objects[0].toString());
