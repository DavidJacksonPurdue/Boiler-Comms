...
public class checkIfCanDM extends AsyncTask {
    ...
    public checkIfCanDM(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try {
            url = new URL(Constants.checkIfCanDM + objects[0].toString() + "_" + objects[1].toString() + "_" + objects[2].toString());
